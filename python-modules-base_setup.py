...
setup(name="python-modules-base",
      ...
      py_modules=["msock", "configfile", "ip", "inet", "icmp", "icmp_twisted",
                  "pinger", "cpu_database", "pci_database", "send_mail",
                  "process_tools", "logging_tools", "server_command",
                  "mail_tools", "xml_tools", "uuid_tools", "upload_file",
                  "upload_server", "net_tools", "threading_tools",
                  "net_logging_tools", "is_server", "ipvx_tools",
                  ...
                  "configfile_old", "libvirt_tools", "pyDes", "stackless_tools",
                  ],
      )
