...
class packet_server_message(message):
    def __init__(self,arg):
        message.__init__(self,"PS",arg=arg)

class packet_server_finish(message):
    def __init__(self,arg):
        message.__init__(self,"PSF",arg=arg)

class install_message(message):
    def __init__(self,arg):
        message.__init__(self,"IN",arg=arg)

class rpm_message(message):
    def __init__(self,arg):
        message.__init__(self,"R",arg=arg)

class rpm_info(message):
    def __init__(self,arg):
        message.__init__(self,"RI",arg=arg)

class return_message(message):
    def __init__(self,arg):
