...
def main():
    ...
    cluster_location.read_config_from_db(
        ...
        [
            ...
            ("MEMCACHE_ADDRESS", configfile.str_c_var("127.0.0.1:8001", help_string="memcache address")),
            ...
            ("MEMCACHE_PORT", configfile.int_c_var(8001, help_string="port on which memcache is reachable [%(default)s]")),
