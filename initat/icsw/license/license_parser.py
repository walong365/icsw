...
class Parser(object):
    def link(self, sub_parser):
        ...
        lic_parser.set_defaults(execute=register_cluster)
        lic_parser.add_argument("-u", "--user", dest='user', required=True, help="your icsw user name")
        lic_parser.add_argument("-p", "--password", dest='password', required=True, help="your icsw password")
        lic_parser.add_argument("-cn", "--cluster-name", dest='cluster_name', required=True,
                                help="cluster name as provided by init.at")
        lic_parser.add_argument("-ci", "--cluster-id", dest='cluster_id', required=True,
                                help="your local autogenerated cluster id")


# TODO: rename model to register_cluster ?
