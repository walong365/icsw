...
#
# Copyright (C) 2012,2014-2016 Andreas Lang-Nevyjel, init.at
#
...
def open_socket(zmq_context):
    ...
    send_sock.setsockopt_string(zmq.IDENTITY, "{}:syslog_scan".format(process_tools.get_machine_name()))  # @UndefinedVariable
