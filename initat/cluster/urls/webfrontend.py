...
report_patterns = [
    ...
    url("^delete_report_history_objects$", report_views.ReportHistoryDeleter.as_view(), name="delete_report_history_objects"),
]
...
monitoring_patterns = [
    ...
    url("^get_node_status", monitoring_views.NodeStatusViewSet.as_view({"post": "get_all"}), name="get_node_status"),
    ...
    url("^search_similar_name$", monitoring_views.search_similar_names.as_view(), name="search_similar_names"),
...
discovery_patterns = [
    ...
    url(r"^load_file_lines$", discovery_views.LoadFileLines.as_view(), name="load_file_lines"),
]
