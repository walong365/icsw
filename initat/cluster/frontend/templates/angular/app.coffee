...
ics_app = angular.module(
    ...
    "DISCOVERY_EVENT_LOG": "{% url 'discovery:EventLog' %}"
    ...
    "REST_DEVICE_SELECTION_DETAIL": "{% url 'rest:DeviceSelectionDetail' 1 %}"
    "REST_DEVICE_SELECTION_LIST": "{% url 'rest:DeviceSelectionList' %}"
