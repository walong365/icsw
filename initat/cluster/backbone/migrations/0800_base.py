...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='user',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='user_idx')),
                ('active', models.BooleanField(default=True)),
                ('login', models.CharField(unique=True, max_length=255)),
                ('uid', models.IntegerField(unique=True)),
                ('aliases', models.TextField(default='', null=True, blank=True)),
                ('home', models.CharField(default='', max_length=128, blank=True)),
                ('shell', models.CharField(default='/bin/bash', max_length=765, blank=True)),
                ('password', models.CharField(max_length=128, blank=True)),
                ('password_ssha', models.CharField(default='', max_length=128, blank=True)),
                ('nt_password', models.CharField(default='', max_length=255, blank=True)),
                ('lm_password', models.CharField(default='', max_length=255, blank=True)),
                ('first_name', models.CharField(default='', max_length=765, blank=True)),
                ('last_name', models.CharField(default='', max_length=765, blank=True)),
                ('title', models.CharField(default='', max_length=765, blank=True)),
                ('email', models.CharField(default='', max_length=765, blank=True)),
                ('pager', models.CharField(default='', max_length=765, verbose_name='mobile', blank=True)),
                ('tel', models.CharField(default='', max_length=765, blank=True)),
                ('comment', models.CharField(default='', max_length=765, blank=True)),
        ...
        migrations.CreateModel(
            name='architecture',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='architecture_idx')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(default='pre-init', max_length=128, choices=[('pre-init', 'before cluster-server detection'), ('pending', 'init and awaiting processing'), ('done', 'job finished'), ('timeout', 'timeout'), ('merged', 'merged with other job')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(default='', max_length=1024, blank=True)),
                ...
                ('comment', models.CharField(default='', max_length=256, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('connection_info', models.CharField(default='not set', max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='device_rsync_config_idx')),
        ...
        migrations.CreateModel(
            name='config',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='new_config_idx')),
                ('name', models.CharField(max_length=192)),
                ('description', models.CharField(default='', max_length=765, blank=True)),
        ...
        migrations.CreateModel(
            name='config_blob',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='config_blob_idx')),
                ('name', models.CharField(max_length=192)),
                ('description', models.CharField(max_length=765, db_column='descr')),
                ('config_old', models.IntegerField(null=True, db_column='config', blank=True)),
                ('value', models.TextField(blank=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('config', models.ForeignKey(to='backbone.config', db_column='new_config_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='config_bool',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='config_bool_idx')),
                ('name', models.CharField(max_length=192)),
                ('description', models.CharField(max_length=765, db_column='descr')),
                ('config_old', models.IntegerField(null=True, db_column='config', blank=True)),
        ...
        migrations.CreateModel(
            name='config_int',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='config_int_idx')),
                ('name', models.CharField(max_length=192)),
                ('description', models.CharField(max_length=765, db_column='descr')),
                ('config_old', models.IntegerField(null=True, db_column='config', blank=True)),
                ('value', models.IntegerField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='config_script',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='config_script_idx')),
                ('name', models.CharField(max_length=192)),
                ('description', models.CharField(max_length=765, db_column='descr')),
                ('enabled', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            name='config_str',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='config_str_idx')),
                ('name', models.CharField(max_length=192)),
                ('description', models.CharField(max_length=765, db_column='descr')),
                ('config_old', models.IntegerField(null=True, db_column='config', blank=True)),
                ('value', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('help_text_html', models.TextField(default='')),
                ('ac_flag', models.BooleanField(default=False)),
                ('ac_type', models.CharField(default='str', max_length=64, choices=[('str', 'string var'), ('int', 'int var'), ('bool', 'bool var')])),
                ('ac_description', models.CharField(default='description', max_length=128)),
                ('ac_value', models.TextField(default='')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('config_hint', models.ForeignKey(to='backbone.config_hint')),
        ...
        migrations.CreateModel(
            name='device',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='device_idx')),
                ('name', models.CharField(max_length=192)),
                ...
                ('stage1_flavour', models.CharField(default='CPIO', max_length=48, blank=True)),
                ...
                ('recvstate', models.TextField(default='not set', blank=True)),
                ('recvstate_timestamp', models.DateTimeField(null=True)),
                ('reqstate', models.TextField(default='not set', blank=True)),
                ...
                ('monitor_checks', models.BooleanField(default=True, verbose_name='Checks enabled', db_column='nagios_checks')),
                ...
                ('enabled', models.BooleanField(default=True)),
                ('md_cache_mode', models.IntegerField(default=1, choices=[(1, 'automatic (server)'), (2, 'never use cache'), (3, 'once (until successfull)')])),
                ...
                ('active_scan', models.CharField(default='', max_length=16, blank=True, choices=[('snmp', 'SNMP'), ('ipmi', 'IPMI'), ('hm', 'Host monitor')])),
            ],
            options={
                'ordering': ('name',),
                'db_table': 'device',
        ...
        migrations.CreateModel(
            name='device_config',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='device_config_idx')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('config', models.ForeignKey(to='backbone.config', db_column='new_config_id')),
        ...
        migrations.CreateModel(
            name='device_group',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='device_group_idx')),
                ('name', models.CharField(unique=True, max_length=192)),
                ('description', models.CharField(default='', max_length=384)),
                ('cluster_device_group', models.BooleanField(default=False)),
                ('enabled', models.BooleanField(default=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(related_name='group_device', db_column='device', blank=True, to='backbone.device', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='device_type',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='device_type_idx')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='device_variable_idx')),
                ...
                ('var_type', models.CharField(max_length=3, choices=[('i', 'integer'), ('s', 'string'), ('d', 'datetime'), ('t', 'time'), ('b', 'blob'), ('?', 'guess')])),
                ('val_str', models.TextField(default='', null=True, blank=True)),
                ('val_int', models.IntegerField(default=0, null=True, blank=True)),
                ('val_blob', models.TextField(default='', null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='devicelog',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='devicelog_idx')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('name', models.CharField(default='', max_length=64)),
                ('full_name', models.CharField(default='', max_length=256, blank=True)),
                ('node_postfix', models.CharField(default='', max_length=16, blank=True)),
                ('depth', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            name='group',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ggroup_idx')),
                ('active', models.BooleanField(default=True)),
                ('groupname', models.CharField(unique=True, max_length=48, db_column='ggroupname')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ng_check_command_idx')),
        ...
        migrations.CreateModel(
            name='image',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='image_idx')),
                ...
                ('build_machine', models.CharField(default='', max_length=192, blank=True)),
                ('device', models.IntegerField(null=True)),
                ('build_lock', models.BooleanField(default=False)),
                ('size', models.BigIntegerField(default=0)),
                ('size_string', models.TextField(default='', blank=True)),
        ...
        migrations.CreateModel(
            name='kernel',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='kernel_idx')),
                ...
                ('target_module_list', models.TextField(default='', blank=True)),
        ...
        migrations.CreateModel(
            name='kernel_build',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='kernel_build_idx')),
                ('build_machine', models.CharField(max_length=192, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='kernel_local_info_idx')),
        ...
        migrations.CreateModel(
            name='kernel_log',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='kernel_log_idx')),
                ('syncer_role', models.CharField(max_length=192, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('name', models.CharField(default='', unique=True, max_length=64)),
                ('image_name', models.CharField(default='', max_length=64, blank=True)),
        ...
        migrations.CreateModel(
            name='log_source',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='log_source_idx')),
        ...
        migrations.CreateModel(
            name='log_status',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='log_status_idx')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('identifier', models.CharField(max_length=192)),
                ('description', models.CharField(default='', max_length=765)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(to='backbone.device', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='lvm_lv',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='lvm_lv_idx')),
        ...
        migrations.CreateModel(
            name='lvm_vg',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='lvm_vg_idx')),
                ('name', models.CharField(max_length=192)),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='mac_ignore',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='mac_ignore_idx')),
                ('macaddr', models.CharField(default='00:00:00:00:00:00', max_length=192, db_column='macadr')),
                ('date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            name='macbootlog',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='macbootlog_idx')),
                ('entry_type', models.CharField(default='???', max_length=96, db_column='type')),
                ('ip_action', models.CharField(default='0.0.0.0', max_length=96, db_column='ip')),
                ('macaddr', models.CharField(default='00:00:00:00:00:00', max_length=192, db_column='macadr')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(to='backbone.device', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('src_file_name', models.CharField(default='', max_length=256, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ng_check_command_type_idx')),
                ('name', models.CharField(unique=True, max_length=192)),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='mon_contact',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ng_contact_idx')),
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('mon_alias', models.CharField(default='', max_length=64, verbose_name='alias', blank=True)),
            ],
            options={
                'db_table': 'ng_contact',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ng_contactgroup_idx')),
                ('name', models.CharField(unique=True, max_length=192)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ng_device_templ_idx')),
                ('name', models.CharField(unique=True, max_length=192)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('md_version', models.CharField(default='', max_length=128)),
                ('device', models.ForeignKey(to='backbone.device')),
            ],
            options={
                'ordering': ('-idx',),
        ...
        migrations.CreateModel(
            name='mon_ext_host',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ng_ext_host_idx')),
                ('name', models.CharField(unique=True, max_length=192)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('state_type', models.CharField(max_length=2, choices=[('H', 'HARD'), ('S', 'SOFT'), ('UD', 'UD'), ('FL', 'FL')])),
                ('state', models.CharField(max_length=2, choices=[('UP', 'UP'), ('D', 'DOWN'), ('UR', 'UNREACHABLE'), ('UD', 'UNDETERMINED'), ('FL', 'FLAPPING')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('state_type', models.CharField(max_length=2, choices=[('H', 'HARD'), ('S', 'SOFT'), ('UD', 'UD'), ('FL', 'FL')])),
                ('state', models.CharField(max_length=2, choices=[('O', 'OK'), ('W', 'WARNING'), ('U', 'UNKNOWN'), ('C', 'CRITICAL'), ('UD', 'UNDETERMINED'), ('FL', 'FLAPPING')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_type', models.CharField(max_length=2, choices=[('H', 'HARD'), ('S', 'SOFT'), ('UD', 'UD')])),
                ('state', models.CharField(max_length=2, choices=[('UP', 'UP'), ('D', 'DOWN'), ('UR', 'UNREACHABLE'), ('UD', 'UNDETERMINED')])),
        ...
        operations.append(
            migrations.CreateModel(
                ...
                fields=[
                    ...
                    ('service_info', models.TextField(null=True, blank=True)),
                    ('state_type', models.CharField(max_length=2, choices=[('H', 'HARD'), ('S', 'SOFT'), ('UD', 'UD')])),
                    ('state', models.CharField(max_length=2, choices=[('O', 'OK'), ('W', 'WARNING'), ('U', 'UNKNOWN'), ('C', 'CRITICAL'), ('UD', 'UNDETERMINED')])),
                    ('log_rotation_state', models.BooleanField(default=False)),
                    ('initial_state', models.BooleanField(default=False)),
                    ('device', models.ForeignKey(to='backbone.device', null=True)),
                    ('logfile', models.ForeignKey(blank=True, to='backbone.mon_icinga_log_file', null=True)),
    ...
    operations.extend([
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=128)),
                ('channel', models.CharField(max_length=8, choices=[('mail', 'E-Mail'), ('sms', 'SMS')])),
                ('not_type', models.CharField(max_length=8, verbose_name='Notification type', choices=[('host', 'Host'), ('service', 'Service')])),
        ...
        migrations.CreateModel(
            name='mon_period',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ng_period_idx')),
                ('name', models.CharField(default='', unique=True, max_length=192)),
                ('alias', models.CharField(default='', unique=True, max_length=255, blank=True)),
                ('sun_range', models.CharField(max_length=48, db_column='sunrange', blank=True)),
                ('mon_range', models.CharField(max_length=48, db_column='monrange', blank=True)),
                ('tue_range', models.CharField(max_length=48, db_column='tuerange', blank=True)),
                ('wed_range', models.CharField(max_length=48, db_column='wedrange', blank=True)),
                ('thu_range', models.CharField(max_length=48, db_column='thurange', blank=True)),
                ('fri_range', models.CharField(max_length=48, db_column='frirange', blank=True)),
                ('sat_range', models.CharField(max_length=48, db_column='satrange', blank=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
            options={
                'db_table': 'ng_period',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='ng_service_templ_idx')),
                ('name', models.CharField(unique=True, max_length=192)),
                ('volatile', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('dev_netdevice_fp', models.CharField(default='', max_length=128, db_index=True)),
                ('srv_netdevice_fp', models.CharField(default='', max_length=128, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('v_type', models.CharField(default='f', max_length=6, choices=[('f', 'float'), ('i', 'integer'), ('b', 'boolean'), ('s', 'string')])),
                ...
                ('lower_crit_float_source', models.CharField(default='n', max_length=4, choices=[('n', 'not set'), ('s', 'system'), ('u', 'user')])),
                ('lower_warn_float_source', models.CharField(default='n', max_length=4, choices=[('n', 'not set'), ('s', 'system'), ('u', 'user')])),
                ('upper_warn_float_source', models.CharField(default='n', max_length=4, choices=[('n', 'not set'), ('s', 'system'), ('u', 'user')])),
                ('upper_crit_float_source', models.CharField(default='n', max_length=4, choices=[('n', 'not set'), ('s', 'system'), ('u', 'user')])),
                ('lower_crit_int_source', models.CharField(default='n', max_length=4, choices=[('n', 'not set'), ('s', 'system'), ('u', 'user')])),
                ('lower_warn_int_source', models.CharField(default='n', max_length=4, choices=[('n', 'not set'), ('s', 'system'), ('u', 'user')])),
                ('upper_warn_int_source', models.CharField(default='n', max_length=4, choices=[('n', 'not set'), ('s', 'system'), ('u', 'user')])),
                ('upper_crit_int_source', models.CharField(default='n', max_length=4, choices=[('n', 'not set'), ('s', 'system'), ('u', 'user')])),
                ...
                ('is_active', models.BooleanField(default=True)),
                ('datasource', models.CharField(default='s', max_length=6, choices=[('c', 'cache'), ('s', 'server'), ('p', 'persistent')])),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(to='backbone.device')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('se_type', models.CharField(max_length=6, choices=[('pde', 'pde'), ('mvl', 'mvl'), ('mve', 'mve')])),
                ('type_instance', models.CharField(default='', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('v_type', models.CharField(default='f', max_length=3, choices=[('i', 'int'), ('f', 'float')])),
        ...
        migrations.CreateModel(
            name='net_ip',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='netip_idx')),
                ('ip', models.CharField(max_length=48)),
                ('penalty', models.IntegerField(default=0, verbose_name='cost')),
                ('alias', models.CharField(default='', max_length=765, blank=True)),
        ...
        migrations.CreateModel(
            name='netdevice',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='netdevice_idx')),
                ('devname', models.CharField(max_length=64)),
                ('macaddr', models.CharField(default='', max_length=177, db_column='macadr', blank=True)),
                ('driver_options', models.CharField(max_length=672, blank=True)),
                ('speed', models.IntegerField(default=0, null=True, blank=True)),
                ('driver', models.CharField(default='e1000e', max_length=384, blank=True)),
                ('routing', models.BooleanField(default=False)),
                ('inter_device_routing', models.BooleanField(default=True)),
                ('penalty', models.IntegerField(default=1, null=True, verbose_name='cost', blank=True)),
                ('dhcp_device', models.NullBooleanField(default=False)),
                ('ethtool_options', models.IntegerField(default=0, null=True, blank=True)),
                ('fake_macaddr', models.CharField(default='', max_length=177, db_column='fake_macadr', blank=True)),
                ('description', models.CharField(max_length=765, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='netdevice_speed_idx')),
        ...
        migrations.CreateModel(
            name='network',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='network_idx')),
                ('identifier', models.CharField(unique=True, max_length=255)),
                ('short_names', models.BooleanField(default=True)),
                ('name', models.CharField(default='', max_length=192, blank=True)),
                ('penalty', models.PositiveIntegerField(default=1, verbose_name='cost')),
                ('postfix', models.CharField(default='', max_length=12, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='network_device_type_idx')),
        ...
        migrations.CreateModel(
            name='network_type',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='network_type_idx')),
                ('identifier', models.CharField(unique=True, max_length=3, choices=[('b', 'boot'), ('p', 'prod'), ('s', 'slave'), ('o', 'other'), ('l', 'local')])),
                ('description', models.CharField(max_length=192)),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='package',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='package_idx')),
                ('name', models.CharField(max_length=128)),
                ('version', models.CharField(max_length=128)),
                ('kind', models.CharField(default='package', max_length=16, choices=[('package', 'Package'), ('patch', 'Patch')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('target_state', models.CharField(default='keep', max_length=8, choices=[('keep', 'keep'), ('install', 'install'), ('upgrade', 'upgrade'), ('erase', 'erase')])),
                ('installed', models.CharField(default='u', max_length=8, choices=[('u', 'unknown'), ('y', 'yes'), ('n', 'no')])),
                ('force_flag', models.BooleanField(default=False)),
                ('nodeps_flag', models.BooleanField(default=False)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('response_type', models.CharField(default='zypper_xml', max_length=16, choices=[('zypper_xml', 'zypper_xml'), ('yum_flat', 'yum_flat'), ('unknown', 'unknown')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repo_type', models.CharField(default='', max_length=128)),
                ('enabled', models.BooleanField(default=True)),
                ...
                ('system_type', models.CharField(default='zypper', max_length=64, choices=[('zypper', 'zypper (suse)'), ('yum', 'yum (redhat)')])),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_search_string', models.CharField(default='', max_length=128, blank=True)),
                ('num_searches', models.IntegerField(default=0)),
                ('current_state', models.CharField(default='ini', max_length=6, choices=[('ini', 'initialised'), ('wait', 'waiting'), ('run', 'search running'), ('done', 'search done')])),
        ...
        migrations.CreateModel(
            name='partition',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='partition_idx')),
                ('mountpoint', models.CharField(default='/', max_length=192, blank=True)),
                ('partition_hex', models.CharField(max_length=6, blank=True)),
                ('size', models.IntegerField(default=100, null=True, blank=True)),
                ('mount_options', models.CharField(default='defaults', max_length=255, blank=True)),
        ...
        migrations.CreateModel(
            name='partition_disc',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='partition_disc_idx')),
                ('disc', models.CharField(max_length=192)),
                ('label_type', models.CharField(default='gpt', max_length=128, choices=[('gpt', 'GPT'), ('msdos', 'MSDOS')])),
                ('priority', models.IntegerField(default=0, null=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='partition_fs',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='partition_fs_idx')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='partition_table_idx')),
                ('name', models.CharField(unique=True, max_length=192)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='peer_information_idx')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('block_device_path', models.CharField(default='', max_length=256)),
                ('mount_path', models.CharField(default='', max_length=512)),
                ('size', models.BigIntegerField(default=0)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(to='backbone.device')),
        ...
        migrations.CreateModel(
            name='status',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='status_idx')),
        ...
        migrations.CreateModel(
            name='sys_partition',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='sys_partition_idx')),
                ('name', models.CharField(max_length=192)),
                ('mountpoint', models.CharField(default='/', max_length=192)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='user_device_login_idx')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(to='backbone.device')),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(default='', max_length=1900)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True)),
                ('var_type', models.CharField(max_length=2, choices=[('s', 'string'), ('i', 'integer'), ('b', 'boolean'), ('n', 'none')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('websockify_process_name', models.CharField(default='', max_length=256, blank=True)),
                ('password', models.CharField(default='', max_length=256, blank=True)),
                ('is_running', models.BooleanField(default=False)),
                ('pid', models.IntegerField(default=0)),
                ('process_name', models.CharField(default='', max_length=256, blank=True)),
        ...
        migrations.CreateModel(
            name='wc_files',
            fields=[
                ('idx', models.AutoField(serialize=False, primary_key=True, db_column='wc_files_idx')),
                ...
                ('dest_type', models.CharField(max_length=8, choices=[('f', 'file'), ('l', 'link'), ('d', 'directory'), ('e', 'erase'), ('c', 'copy'), ('i', 'internal')])),
        ...
        migrations.AddField(
            ...
            name='hnperiod',
            field=models.ForeignKey(related_name='host_n_period', verbose_name='host period', to='backbone.mon_period'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='mon_contact',
        ...
        migrations.AddField(
            model_name='mon_contact',
            name='snperiod',
            field=models.ForeignKey(related_name='service_n_period', verbose_name='service period', to='backbone.mon_period'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='mon_contact',
        ...
        migrations.AddField(
            model_name='device',
            name='new_state',
            field=models.ForeignKey(db_column='newstate_id', blank=True, to='backbone.status', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='device',
        ...
        migrations.AddField(
            model_name='device',
            name='prod_link',
            field=models.ForeignKey(db_column='prod_link', blank=True, to='backbone.network', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='device',
