# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2016-12-07 08:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ui_theme_selection', models.CharField(default='default', max_length=64)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('v_type', models.CharField(choices=[('f', 'float'), ('i', 'integer'), ('b', 'boolean'), ('s', 'string'), ('B', 'blob')], default='f', max_length=6)),
                ...
                ('value_blob', models.TextField(blank=True, default='')),
