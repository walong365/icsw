# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-25 11:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_status', models.IntegerField(choices=[(1, 'PLANNED'), (2, 'RUNNING'), (3, 'FINISHED_RUNS'), (4, 'GENERATING_ASSETS'), (5, 'FINISHED')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('package_type', models.IntegerField(choices=[(1, 'WINDOWS'), (2, 'LINUX')])),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_status', models.IntegerField(choices=[(1, 'PLANNED'), (2, 'SCANNING'), (3, 'FINISHED_SCANNING'), (4, 'GENERATING_ASSETS'), (5, 'FINISHED')], default=1)),
                ('run_result', models.IntegerField(choices=[(1, 'UNKNOWN'), (2, 'SUCCESS'), (3, 'WARNING'), (4, 'FAILED'), (5, 'CANCELED')], default=1)),
                ('run_type', models.IntegerField(choices=[(1, 'PACKAGE'), (2, 'HARDWARE'), (3, 'LICENSE'), (4, 'UPDATE'), (5, 'LSHW'), (6, 'PROCESS'), (7, 'PENDING_UPDATE'), (8, 'DMI'), (9, 'PCI'), (10, 'PRETTYWINHW'), (11, 'PARTITION'), (12, 'LSBLK'), (13, 'XRANDR')], default=1)),
                ('run_start_time', models.DateTimeField(blank=True, null=True)),
                ('run_end_time', models.DateTimeField(blank=True, null=True)),
                ...
                ('scan_type', models.IntegerField(choices=[(1, 'HM'), (2, 'NRPE')], null=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            name='device',
            fields=[
                ('idx', models.AutoField(db_column='device_idx', primary_key=True, serialize=False)),
                ('name', models.CharField(default='', max_length=192)),
                ('alias', models.CharField(blank=True, default='', max_length=384)),
                ('comment', models.CharField(blank=True, default='', max_length=384)),
                ('etherboot_valid', models.BooleanField(default=False)),
                ('kernel_append', models.CharField(blank=True, max_length=384)),
                ('stage1_flavour', models.CharField(blank=True, default='cpio', max_length=48)),
                ...
                ('monitor_checks', models.BooleanField(db_column='nagios_checks', default=True, verbose_name='Checks enabled')),
        ...
        migrations.CreateModel(
            name='device_group',
            fields=[
                ('idx', models.AutoField(db_column='device_group_idx', primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=192, unique=True)),
                ('description', models.CharField(blank=True, default='', max_length=384)),
                ('cluster_device_group', models.BooleanField(default=False)),
                ('enabled', models.BooleanField(default=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(blank=True, db_column='device', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='group_device', to='backbone.device')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(db_column='device_rsync_config_idx', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.TextField(blank=True, default='', max_length=64)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backbone.device')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(default='', max_length=64, unique=True)),
                ('baseline', models.IntegerField(choices=[(0, 'year'), (1, 'month'), (2, 'week'), (3, 'day'), (4, 'hour'), (5, 'minute'), (6, 'second')])),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(primary_key=True, serialize=False)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('source', models.IntegerField(choices=[(1, 'SNMP'), (2, 'ASU'), (3, 'IPMI'), (4, 'PACKAGE'), (5, 'HARDWARE'), (6, 'LICENSE'), (7, 'UPDATE'), (8, 'SOFTWARE_VERSION'), (9, 'PROCESS'), (10, 'PENDING_UPDATE')])),
                ('duration_amount', models.IntegerField(default=1)),
                ('duration_unit', models.IntegerField(choices=[(1, 'months'), (2, 'weeks'), (3, 'days'), (4, 'hours'), (5, 'minutes')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legend_mode', models.CharField(choices=[('f', 'full with values'), ('t', 'only text'), ('n', 'nothing')], default='f', max_length=4)),
                ('cf', models.CharField(choices=[('MIN', 'minimum'), ('AVERAGE', 'average'), ('MAX', 'maximum')], default='AVERAGE', max_length=16)),
        ...
        migrations.CreateModel(
            name='log_status',
            fields=[
                ('idx', models.AutoField(db_column='log_status_idx', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='mac_ignore',
            fields=[
                ('idx', models.AutoField(db_column='mac_ignore_idx', primary_key=True, serialize=False)),
                ('macaddr', models.CharField(db_column='macadr', default='00:00:00:00:00:00', max_length=192)),
                ('date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            name='macbootlog',
            fields=[
                ('idx', models.AutoField(db_column='macbootlog_idx', primary_key=True, serialize=False)),
                ('entry_type', models.CharField(db_column='type', default='???', max_length=96)),
                ('ip_action', models.CharField(db_column='ip', default='0.0.0.0', max_length=96)),
                ('macaddr', models.CharField(db_column='macadr', default='00:00:00:00:00:00', max_length=192)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('device', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backbone.device')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, to='backbone.category')),
                ('config', models.ForeignKey(blank=True, db_column='new_config_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='backbone.config')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desired_status', models.CharField(choices=[('i', 'ignore'), ('u', 'up'), ('d', 'down')], default='i', max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(primary_key=True, serialize=False)),
                ('aggregation_level', models.CharField(choices=[('n', 'none'), ('h', 'hour'), ('d', 'day'), ('m', 'month'), ('y', 'year')], default='n', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.IntegerField(choices=[(1, 'INTEGER'), (2, 'STRING'), (3, 'DATE'), (4, 'TEXT')])),
                ('optional', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            name='status',
            fields=[
                ('idx', models.AutoField(db_column='status_idx', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dest_type', models.CharField(choices=[('f', 'file'), ('l', 'link'), ('d', 'directory'), ('e', 'erase'), ('c', 'copy'), ('i', 'internal')], max_length=8)),
        ...
        migrations.AddField(
            model_name='device',
            name='new_state',
            field=models.ForeignKey(blank=True, db_column='newstate_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='backbone.status'),
        ),
        migrations.AddField(
            model_name='device',
            name='partition_table',
        ...
        migrations.AddField(
            model_name='device',
            name='prod_link',
            field=models.ForeignKey(blank=True, db_column='prod_link', null=True, on_delete=django.db.models.deletion.CASCADE, to='backbone.network'),
        ),
        migrations.AddField(
            model_name='device',
            name='snmp_schemes',
