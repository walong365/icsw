...
LicenseEnum = Enum('LicenseEnum', 'md_config_server kpi graphing discovery_server monitoring_dashboard distributed_monitoring snapshot notification network_weathermap rootkit_hunter reporting ext_license virtual_desktop hpc_workbench package_install rms netboot fast_frontend asset')
LicenseEnum.to_user_name = lambda x: dict((
    ...
    (LicenseEnum.asset, 'Asset Management')
)).get(x, None)
...
LicenseParameterTypeEnum = Enum('LicenseParameterTypeEnum', 'ovum')
