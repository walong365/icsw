...
def get_available_licenses():
    ...
    available_licenses.append(AvailableLicense(id=u'fast_frontend', enum_value=LicenseEnum.fast_frontend, name=u'Single-Page mode for Webfrontend', description=u'Creates the Webfrontend in a super-fast single-page app', product=InitProduct.NOCTUA))
