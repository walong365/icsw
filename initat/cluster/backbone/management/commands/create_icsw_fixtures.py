...
from .fixtures import ianaiftype_mib, add_fixtures
...
def _add_snmp_fixtures():
    ...
    # SNMP Network types
    for iana_type in ianaiftype_mib.IANAIfTypes:
        factories.SNMPNetworkType(
            if_type=iana_type.idx,
            if_label=iana_type.name,
            description=iana_type.description,
            regex=iana_type.regex,
            mac_bytes=iana_type.mac_bytes,
        )
    # SNMP fixtures
