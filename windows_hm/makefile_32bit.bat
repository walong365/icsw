...
bin\wget -nc https://sourceforge.net/projects/winpython/files/WinPython_3.%WINPYTH_MAJOR%/3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%.%WINPYTH_MINORFIX%/WinPython-32bit-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%.%WINPYTH_MINORFIX%Qt5.exe
bin\wget -nc https://sourceforge.net/projects/winpython/files/WinPython_3.%WINPYTH_MAJOR%/3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%.%WINPYTH_MINORFIX%/WinPython-32bit-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%.%WINPYTH_MINORFIX%Zero.exe


bin\7z -o.\tmp\zero x WinPython-32bit-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%.%WINPYTH_MINORFIX%Zero.exe
bin\7z -o.\tmp\full x WinPython-32bit-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%.%WINPYTH_MINORFIX%Qt5.exe


COPY .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\pywintypes3%WINPYTH_MAJOR%.dll  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\
COPY .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\pythoncom3%WINPYTH_MAJOR%.dll  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\

COPY .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\PyWin32.chm  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\
COPY .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\pywin32.pth  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\
COPY .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\pywin32.version.txt  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\
COPY .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\pythoncom.py  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\


MOVE .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\pythonwin  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\
MOVE .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\pywin32_system32  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\
MOVE .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\win32  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\
MOVE .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\win32com  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\
MOVE .\tmp\full\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\win32comext  .\tmp\zero\python-3.%WINPYTH_MAJOR%.%WINPYTH_MINOR%\Lib\site-packages\
